...
struct NoModelState: View {
    ...
    var body: some View {
        ChatPlaceholder(
            ...
            message: String(localized: "Vela runs entirely on your device — pick a model to download once, then chat offline with nothing leaving your phone.", bundle: .main),
